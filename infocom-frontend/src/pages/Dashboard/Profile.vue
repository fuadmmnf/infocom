  ...
  <q-page class="flex flex-center">
    <div class="row justify-center q-my-md">
      <q-card flat bordered class="q-pa-lg" style="min-width: 40%">
        <q-card-section>
            <div class="row">
              <q-input class="col-12 q-my-xs q-px-xs" filled  :value="$store.getters.getUser.name" label="Name" />
              <q-input class="col-12 q-my-xs q-px-xs" filled  :value="$store.getters.getUser.phone" label="Phone" />
              <q-input class="col-12 q-my-xs q-px-xs" filled  :value="$store.getters.getUser.email" label="Email" />
