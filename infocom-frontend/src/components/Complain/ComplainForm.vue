<template>
  <q-form @submit="complain.status === undefined? createComplain(): updateComplain()" @reset="complain = {}" class="q-gutter-md">
    <div class="row">
    ...
    <div v-if="departments.length" class="row q-my-none">
    ...
    <q-input class=" q-my-xs q-px-xs" filled clearable v-model="complain.complain_summary" type="textarea" autogrow
